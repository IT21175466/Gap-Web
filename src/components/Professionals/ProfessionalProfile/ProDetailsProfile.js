                ...
                <div>
                  ...
                  <div class="cardfu">
                      ...
                      <div class="card-bodyy">
                        <div class="text-section">
                          <h5 class="card-title fw-bold">
                            Innovate Lanka Pvt (LTD)
                          </h5>
                          <p className="card-para2">Founder</p>
                          <p className="card-para2">
                            Technology | Small Business
                          </p>
                          <p className="card-para2">
                            Lorem ipsum dolor sit amet consectetur. Habitant
                            senectus leo suscipit dolor sed. Pulvinar sit mauris
                            quisque
                          </p>
                          <p className="card-para2">https://innovatetech.com</p>
                          <div class="row mt-4">
                            <div class="col-4">
                        ...
                        <div class="card-body">
                          <div class="text-section">
                            ...
                            <p className="card-para3">
                              Colombo, Western, Sri Lanka | Remote
                            </p>
                            <p className="card-para3">
                              Mar 2021 - Present | 2 yrs 4 mos
                            </p>
                            <p className="card-para3">
                              Skills - Auto Layout | Security | JSON | REST APIs
                              | Leadership | Problem Solving | Mentoring
                            </p>
                            <div class="row mt-4">
                              <div class="col-4">
                                <div class="position-absolute top-0 end-0 p-3">
                      ...
                      >
                        ...
                        <div class="card-body">
                          <div class="text-section">
                            ...
                            <p className="card-para3">
                              Skills - Agile Methodology | Public Speaking |
                              Presentation Skills | Problem Solving | Swift
                            </p>
                            <div class="row mt-4">
                              <div class="col-4">
                                <div class="position-absolute top-0 end-0 p-3">
                      ...
                      >
                        ...
                        <div class="card-body">
                          <div class="text-section">
                            ...
                            <p className="card-para3">
                              Skills - Objective-C | XCode | Mobile Development
                              | Mac | Object-oriented Programming | Relational
                              Database | Testing
                            </p>
                            <div class="row mt-4">
                              <div class="col-4">
                      ...
                      <div class="card cardnew" style={{ border: "0" }}>
                        <div class="card-body">
                          <div class="text-section">
                            ...
                            <p className="card-para2">
                              SimplyLearn Online Academy
                            </p>
                            <p className="card-para2">
                              License Number - 5B568963C
                            </p>
                            <p className="card-para2">
                              July 2023 | Valid 1 year
                            </p>
                      ...
                      <div class="card cardnew" style={{ border: "0" }}>
                        <div class="card-body">
                          <div class="text-section">
                            ...
                            <p className="card-para2">License Number -</p>
                            <p className="card-para2">
                              Jan 2023 | Valid 1 year
                            </p>
                            <div class="row mt-4">
                              <div class="col-4">
                                <div class="position-absolute top-0 end-0 p-3">
                    ...
                    <div class="card cardnew">
                      <div class="card-body">
                        <div class="text-section">
                          <h5 class="card-title2 fw-bold">Developer</h5>
                          <p className="card-para2">
                            Generation Alpha, Sri Lanka
                          </p>
                          <p className="card-para2">
                            Feb 2021 - Present | 1 yr 5 mo
                          </p>
                  ...
                  <br></br>
                  <div className="container mt-1 cdcon">
                    <div className="row">
                      {/* First Box */}
                      <div className="col-md-6 cd mb-4">
                        <div style={{ padding: "10px" }}>
                          {/* Nested row for profile photo and details */}
                          <div className="row">
                            ...
                            <div className="col-md-10 position-relative">
                              <div className="cardhh">
                                <div className="card-body">
                                  <p className="card-hed">Julia Ruth</p>
                                  <p className="card-text">
                                    Lorem ipsum dolor sit amet consectetur.
                                    Habitant senectus leo suscipit dolor sed.
                                    Pulvinar sit mauris quisque fermentum risus
                                    tellus lorem orci. Amet nibh amet ut vitae
                                    et urna condimentum diam. Est vitae nibh
                                    ullamcorper ultrices viverra
                                  </p>
                                </div>
...
export default ProDetailsProfile;
