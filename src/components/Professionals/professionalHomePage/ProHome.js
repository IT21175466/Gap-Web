...
import Homepage_image from "./img/homepage.png";
import "./HomeS.css";
import GAP_Image from "./img/GAP_BG.png";
import Student_Image from "./img/Student.png";
import cal from "./img/cal.png";
import interview from "./img/interviews.png";
import Level from "./img/level.jpg";
...
import NewPro1 from "./img/newpro1.png";
import NewPro2 from "./img/newpro2.png";
import NewPro3 from "./img/newpro3.png";
          ...
          <div className="row">
            ...
            <div className="col-lg-9 vh-100 ">
              ...
              <div className="col-lg-12 custom-Point d-flex mt-4 ">
                <div className="col-lg-9" style={{ padding: "10px 0 0 0" }}>
                  <h1
                    style={{
                      fontSize: "44px",
                    ...
                    className="custom-S-text1 mt-4"
                  >
                    Hello julius!!
                  </h1>
                  <h4
                    style={{ fontSize: "24px", fontFamily: "YourFontFamily" }}
                    className="custom-S-text2"
                  >
              ...
              <div class="container">
                <div class="row">
                  <div class="col-12 col-md-4 mb-3">
                    <div class="card">
                      <img src={cal} class="card-img-top imgg" alt="img" />
                      <div class="card-body">
                        <div class="text-section">
                          <h5 class="card-title fw-bold">Add time slot</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-4 mb-3">
                    <div class="card">
                      <img
                        src={interview}
                        class="card-img-top imgg"
                        alt="img"
                      />
                      <div class="card-body">
                        <div class="text-section">
                          <h5 class="card-title fw-bold">Be a mentor</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="col-12 col-md-4 mb-3">
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="text-section">
                          <h5 class="card-title fw-bold">Post ads</h5>
                        </div>
                      </div>
                    </div>
                  </div>
                        ...
                        <div className="custom-box">
                          <div className="row">
                            ...
                            <div className="col-md-8 col-sm-12">
                              <h3>Tiara Perera</h3>
                              <p>student at university of Colombo</p>
                            </div>
                            <div>
                              <p>
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit. Ut condimentum eu arcu vel
                                tempus. Ut faucibus id velit vel porttitor
                              </p>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="col-12 col-md-12 mb-3">
                    <div class="cardnew">
                      <img src={NewPro1} class="card-img-top imgr" alt="img" />
                      <div class="card-body d-flex justify-content-between align-items-start">
                        <div class="text-section">
                          <h5 class="card-title fw-bold"> Dulcie ember</h5>
                          <p>student at university of Colombo</p>
                          ...
                          <p>
                            ...
                            >
                              <path
                                d="M6.78426 9.5716C6.85137 9.63848 6.90462 9.71795 6.94095 9.80546C6.97729 9.89296 6.99599 9.98678 6.99599 10.0815C6.99599 10.1763 6.97729 10.2701 6.94095 10.3576C6.90462 10.4451 6.85137 10.5246 6.78426 10.5915L6.42791 10.9478C5.75266 11.623 4.83682 12.0024 3.88188 12.0024C2.92693 12.0024 2.0111 11.623 1.33585 10.9478C0.660601 10.2726 0.28125 9.35672 0.28125 8.40177C0.28125 7.44683 0.660601 6.53099 1.33585 5.85574L2.78284 4.40935C3.43163 3.75895 4.30456 3.38124 5.22282 3.35358C6.14107 3.32592 7.03515 3.65041 7.72192 4.26058C7.79282 4.3236 7.85062 4.39998 7.892 4.48534C7.93339 4.5707 7.95756 4.66338 7.96313 4.75808C7.9687 4.85278 7.95557 4.94765 7.92447 5.03728C7.89338 5.1269 7.84493 5.20952 7.78191 5.28043C7.71888 5.35133 7.64251 5.40913 7.55715 5.45051C7.47179 5.4919 7.37911 5.51607 7.28441 5.52164C7.18971 5.52721 7.09483 5.51408 7.00521 5.48298C6.91559 5.45189 6.83296 5.40344 6.76206 5.34042C6.35023 4.97467 5.81422 4.78009 5.26367 4.79648C4.71311 4.81287 4.18963 5.039 3.80029 5.42861L2.3545 6.8732C1.94942 7.27828 1.72184 7.82769 1.72184 8.40057C1.72184 8.97345 1.94942 9.52286 2.3545 9.92795C2.75959 10.333 3.309 10.5606 3.88188 10.5606C4.45476 10.5606 5.00417 10.333 5.40926 9.92795L5.7656 9.5716C5.83246 9.50467 5.91186 9.45157 5.99925 9.41534C6.08665 9.37911 6.18032 9.36047 6.27493 9.36047C6.36953 9.36047 6.46321 9.37911 6.55061 9.41534C6.638 9.45157 6.7174 9.50467 6.78426 9.5716ZM11.2284 1.05284C10.5526 0.378634 9.63698 0 8.68238 0C7.72778 0 6.81215 0.378634 6.13635 1.05284L5.78 1.40919C5.64476 1.54443 5.56878 1.72786 5.56878 1.91912C5.56878 2.11038 5.64476 2.2938 5.78 2.42904C5.91524 2.56428 6.09867 2.64026 6.28993 2.64026C6.48119 2.64026 6.66461 2.56428 6.79985 2.42904L7.1562 2.0727C7.56129 1.66761 8.1107 1.44004 8.68358 1.44004C9.25646 1.44004 9.80587 1.66761 10.211 2.0727C10.616 2.47778 10.8436 3.0272 10.8436 3.60007C10.8436 4.17295 10.616 4.72236 10.211 5.12745L8.76457 6.57444C8.37489 6.96388 7.85111 7.18968 7.30042 7.20563C6.74973 7.22157 6.21376 7.02647 5.8022 6.66023C5.73129 6.5972 5.64867 6.54876 5.55905 6.51766C5.46942 6.48657 5.37455 6.47343 5.27985 6.479C5.18515 6.48458 5.09247 6.50874 5.00711 6.55013C4.92175 6.59152 4.84537 6.64931 4.78235 6.72022C4.71932 6.79112 4.67088 6.87374 4.63979 6.96337C4.60869 7.05299 4.59555 7.14787 4.60112 7.24257C4.6067 7.33727 4.63086 7.42995 4.67225 7.51531C4.71364 7.60067 4.77143 7.67704 4.84234 7.74007C5.52863 8.3501 6.42211 8.67479 7.33993 8.64769C8.25775 8.62059 9.13052 8.24375 9.77962 7.59429L11.2266 6.1479C11.9016 5.47227 12.2809 4.55639 12.2812 3.60135C12.2816 2.6463 11.9029 1.73016 11.2284 1.05404V1.05284Z"
                                fill="black"
                                fill-opacity="0.8"
                              />
                            </svg>
                            &nbsp; https://meet.google.com/ghi-islb-zuq
                          </p>
                          <p>
                            {" "}
                            <svg
                            ...
                            >
                              <path
                                d="M3.68505 0C3.79644 0 3.90327 0.0442499 3.98203 0.123015C4.0608 0.20178 4.10505 0.308609 4.10505 0.42V1.2054H8.61525V0.4254C8.61525 0.314009 8.6595 0.20718 8.73827 0.128415C8.81703 0.0496499 8.92386 0.0054 9.03525 0.0054C9.14664 0.0054 9.25347 0.0496499 9.33223 0.128415C9.411 0.20718 9.45525 0.314009 9.45525 0.4254V1.2054H11.0813C11.3994 1.2054 11.7045 1.33175 11.9296 1.55666C12.1546 1.78157 12.2811 2.08664 12.2812 2.4048V10.8006C12.2811 11.1188 12.1546 11.4238 11.9296 11.6487C11.7045 11.8737 11.3994 12 11.0813 12H1.48125C1.16309 12 0.85796 11.8737 0.632934 11.6487C0.407908 11.4238 0.281409 11.1188 0.28125 10.8006L0.28125 2.4048C0.281409 2.08664 0.407908 1.78157 0.632934 1.55666C0.85796 1.33175 1.16309 1.2054 1.48125 1.2054H3.26505V0.4194C3.26521 0.308113 3.30953 0.201438 3.38828 0.122803C3.46703 0.0441674 3.57376 -1.13558e-07 3.68505 0ZM1.12125 4.6452V10.8006C1.12125 10.8479 1.13056 10.8947 1.14865 10.9384C1.16675 10.982 1.19326 11.0217 1.22669 11.0552C1.26012 11.0886 1.29981 11.1151 1.34348 11.1332C1.38716 11.1513 1.43397 11.1606 1.48125 11.1606H11.0813C11.1285 11.1606 11.1753 11.1513 11.219 11.1332C11.2627 11.1151 11.3024 11.0886 11.3358 11.0552C11.3692 11.0217 11.3958 10.982 11.4138 10.9384C11.4319 10.8947 11.4412 10.8479 11.4412 10.8006V4.6536L1.12125 4.6452ZM4.28145 8.7714V9.771H3.28125V8.7714H4.28145ZM6.78105 8.7714V9.771H5.78145V8.7714H6.78105ZM9.28125 8.7714V9.771H8.28105V8.7714H9.28125ZM4.28145 6.3852V7.3848H3.28125V6.3852H4.28145ZM6.78105 6.3852V7.3848H5.78145V6.3852H6.78105ZM9.28125 6.3852V7.3848H8.28105V6.3852H9.28125ZM3.26505 2.0448H1.48125C1.43397 2.0448 1.38716 2.05411 1.34348 2.0722C1.29981 2.09029 1.26012 2.11681 1.22669 2.15024C1.19326 2.18367 1.16675 2.22336 1.14865 2.26703C1.13056 2.31071 1.12125 2.35752 1.12125 2.4048V3.8058L11.4412 3.8142V2.4048C11.4412 2.35752 11.4319 2.31071 11.4138 2.26703C11.3958 2.22336 11.3692 2.18367 11.3358 2.15024C11.3024 2.11681 11.2627 2.09029 11.219 2.0722C11.1753 2.05411 11.1285 2.0448 11.0813 2.0448H9.45525V2.6022C9.45525 2.71359 9.411 2.82042 9.33223 2.89918C9.25347 2.97795 9.14664 3.0222 9.03525 3.0222C8.92386 3.0222 8.81703 2.97795 8.73827 2.89918C8.6595 2.82042 8.61525 2.71359 8.61525 2.6022V2.0448H4.10505V2.5968C4.10505 2.70819 4.0608 2.81502 3.98203 2.89378C3.90327 2.97255 3.79644 3.0168 3.68505 3.0168C3.57366 3.0168 3.46683 2.97255 3.38807 2.89378C3.3093 2.81502 3.26505 2.70819 3.26505 2.5968V2.0448Z"
                                fill="black"
                                fill-opacity="0.8"
                              />
                            </svg>
                          ...
                          <p>
                            ...
                            >
                              <path
                                d="M6.27525 0C2.96325 0 0.28125 2.688 0.28125 6C0.28125 9.312 2.96325 12 6.27525 12C9.59325 12 12.2812 9.312 12.2812 6C12.2812 2.688 9.59325 0 6.27525 0ZM6.28125 10.8C3.62925 10.8 1.48125 8.652 1.48125 6C1.48125 3.348 3.62925 1.2 6.28125 1.2C8.93325 1.2 11.0813 3.348 11.0813 6C11.0813 8.652 8.93325 10.8 6.28125 10.8ZM6.58125 3H5.68125V6.6L8.83125 8.49L9.28125 7.752L6.58125 6.15V3Z"
                                fill="black"
                                fill-opacity="0.8"
                              />
                            </svg>
                          ...
                          <p>
                            ...
                            id velit vel porttitorLorem ipsum dolor sit amet,
                            consectetur adipiscing elit. Ut condimentum eu arcu
                            vel tempus. Ut faucibus id velit vel porttitor
                          </p>
                        </div>
                        <button
                        ...
                        >
                          ...
                          >
                            <path
                              d="M2.41809 6.13636C1.61773 6.13636 0.962891 5.52273 0.962891 4.77273V1.36364C0.962891 0.613636 1.61773 0 2.41809 0H8.23889C9.03925 0 9.69409 0.613636 9.69409 1.36364V4.77273C9.69409 5.52273 9.03925 6.13636 8.23889 6.13636H6.78369V8.18182L4.60089 6.13636H2.41809ZM15.5149 10.2273C16.3152 10.2273 16.9701 9.61364 16.9701 8.86364V5.45455C16.9701 4.70455 16.3152 4.09091 15.5149 4.09091H11.1493V4.77273C11.1493 6.27273 9.83961 7.5 8.23889 7.5V8.86364C8.23889 9.61364 8.89373 10.2273 9.69409 10.2273H11.1493V12.2727L13.3321 10.2273H15.5149Z"
                              fill="white"
                            />
                          </svg>
                        </button>
                    ...
                    <br></br>
                    <div class="cardnew">
                      <img src={NewPro2} class="card-img-top imgr" alt="img" />
                      <div class="card-body d-flex justify-content-between align-items-start">
                        <div class="text-section">
                          <h5 class="card-title fw-bold"> Dulcie ember</h5>
                          <p>student at university of Colombo</p>
                    ...
                    <br></br>
                    <div class="cardnew">
                      <img src={NewPro3} class="card-img-top imgr" alt="img" />
                      <div class="card-body d-flex justify-content-between align-items-start">
                        <div class="text-section">
                          <h5 class="card-title fw-bold"> Dulcie ember</h5>
                          <p>student at university of Colombo</p>
