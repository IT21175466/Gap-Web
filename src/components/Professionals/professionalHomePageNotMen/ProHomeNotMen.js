            ...
            <div className="col-lg-9 vh-100 ">
              ...
              <div class="container">
                <div class="row">
                  ...
                  <div class="col-12 col-md-4 mb-3">
                    <div class="card">
                      <img src={ad} class="card-img-top imgg" alt="img" />
                      <div class="card-body">
                        <div class="text-section">
                  ...
                  <div className="container-fluid">
                    <div className="row justify-content-center">
                      <div className="col-md-12 col-12">
                        ...
                        >
                          <img
                            src={Bxlg} // Replace with your image source
                            alt="Example"
                            className="img-fluid"
                            style={{
                              width: "150px",
                          ...
                          >
                            “looks like you haven't requested and scheduled
                            session as you're not yet a mentor. Elevate your
                            profile by joining our mentor community and start
