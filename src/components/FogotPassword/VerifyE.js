...
// export class VerifyE extends Component {
//   static propTypes = {}
...
import VerifyEmail_image from '../FogotPassword/VerifyEmail.png';
import Email_image from '../FogotPassword/email.png';
                        ...
                        <div className='row'>
                            <div className='col-lg-5 vh-100 custom-bg d-flex align-items-center justify-content-center'>
                                <div className="vh-100 text-center">
                                    <img src={VerifyEmail_image} alt='Your Image' className='img-fluid custom-image-LI' />
