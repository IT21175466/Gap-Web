...
import VerifyMobile_image from '../FogotPassword/VerifyMobile.png';
import Moblie_image from '../FogotPassword/mobile.png';
                        ...
                        <div className='row'>
                            <div className='col-lg-5 vh-100 custom-bg d-flex align-items-center justify-content-center'>
                                <div className="vh-100 text-center">
                                    <img src={VerifyMobile_image} alt='Your Image' className='img-fluid custom-image-LI' />
