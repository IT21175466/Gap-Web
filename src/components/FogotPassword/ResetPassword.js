...
import Createpassword_image from '../FogotPassword/createpassword.png';
import Password_image from '../FogotPassword/password.png';
import Unlock_image from '../FogotPassword/unlock.png';
                    ...
                    <div className='row'>
                        <div className='col-lg-5 vh-100 custom-bg d-flex align-items-center justify-content-center'>
                            <div className="vh-100 text-center">
                                <img src={Createpassword_image} alt='Your Image' className='img-fluid custom-image-LI' />
                                <h1 className='custom-text1 mb-3 mt-5'>Welcome to GAP</h1>
                                <h4 className='custom-text2'>We will help you recover your password</h4>
                            </div>
                        </div>
