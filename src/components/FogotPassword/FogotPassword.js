...
import Forgotpassword_image from '../FogotPassword/forgotpassword.png';
import Lock_image from '../FogotPassword/lock.png';
          ...
          <div className='row'>
            <div className='col-lg-5 vh-100 custom-bg d-flex align-items-center justify-content-center'>
              <div className="vh-100 text-center">
                <img src={Forgotpassword_image} alt='Your Image' className='img-fluid custom-image-LI' />
                <h1 className=' custom-text1 mb-3 mt-1' >Welcome to GAP</h1>
